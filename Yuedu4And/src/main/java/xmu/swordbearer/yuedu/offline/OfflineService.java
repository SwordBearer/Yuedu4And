...
public class OfflineService extends Service {
    ...
    private void startDownload() {
        ...
        SharedPreferences pref = getSharedPreferences(PREF_OFFLINE, Context.MODE_PRIVATE);
    ...
    private void showNotification(int trickerText) {
        ...
        notification.setLatestEventInfo(this, res.getString(R.string.offline_ing),
                null, pi);
    ...
    private void tirggerNext() {
        SharedPreferences prefs = getSharedPreferences(PREF_OFFLINE, Context.MODE_PRIVATE);
        ...
        am.set(AlarmManager.RTC_WAKEUP, System.currentTimeMillis() + atTimeInMillis, pi);
    }
