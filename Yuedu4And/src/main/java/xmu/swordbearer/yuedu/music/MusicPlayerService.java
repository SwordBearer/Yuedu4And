 ...
 */
public class MusicPlayerService extends Service implements MediaPlayer.OnErrorListener, MediaPlayer.OnBufferingUpdateListener {
    ...
    public static final String ACTION_SEEK_TO = "action_seekto";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (action.equals(ACTION_TOGGLE_PLAY)) {
            toggle();
        } else if (action.equals(ACTION_START_PLAY)) {//play
    ...
    private void showNotification(Music music) {
        ...
        notification.setLatestEventInfo(this, "乐读正在播放:",
                "Playing: " + music.name, pi);
        Log.e(TAG, "显示通知栏");
