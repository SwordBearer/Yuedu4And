...
import xmu.swordbearer.yuedu.core.weather.DataInitializer;
import xmu.swordbearer.yuedu.core.weather.MyLocation;


public class WeatherSeetingActivity extends Activity {
    ...
    private void init() {
        Runnable r = new Runnable() {
            public void run() {
                DataInitializer cityDataInit = new DataInitializer(WeatherSeetingActivity.this);
    ...
    private void initProvince() {
        DBManager dm = new DBManager(WeatherSeetingActivity.this);
