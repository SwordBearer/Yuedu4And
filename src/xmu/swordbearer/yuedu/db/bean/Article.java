...
public class Article extends BaseBean {
    public int id;//0 存放在sqlite的ID
    public int cloudId;//1 //存放在云端数据库的ID，两者很有可能不相同
    public String title;//2 标题
    public String author;//  作者
    public String source;//4 来源
    public String outline;//  简介
    public long birth;//6 发布日期
    public String content;//7 文章内容
